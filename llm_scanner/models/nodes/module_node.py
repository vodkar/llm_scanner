...
class ModuleNode(BaseModel):
    ...
    imports: list[str] = Field(default_factory=list, description="Imported modules and symbols")
    exports: list[str] = Field(default_factory=list, description="Publicly exported symbols")
